...
export const CAN_REPORT_ISSUES        = [ROLE.ADMIN, ROLE.SHOP_MANAGER, ROLE.DISPATCHER, ROLE.MECHANIC, ROLE.DRIVER] // can set issues/oos but drivers cannot set ready
export const CAN_ADD_MECHANIC_NOTE    = [ROLE.ADMIN, ROLE.SHOP_MANAGER, ROLE.DISPATCHER, ROLE.MECHANIC]
export const CAN_MANAGE_TRUCKS        = [ROLE.ADMIN, ROLE.SHOP_MANAGER, ROLE.DISPATCHER]
